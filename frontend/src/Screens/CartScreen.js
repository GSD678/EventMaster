                      ...
                      onChange={(e) =>
                        {
                          ...
                          dispatch(addToCart(item.event, Number(e.target.value - item.qty)));
                        }
                      }
                    >
                      {[...Array(item.ticketsavail).keys()].map((x) => (
        ...
        <Card>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              $
              {cartItems
                .reduce((acc, item) => acc + item.qty * item.ticketprice, 0)
                .toFixed(2)}
            </ListGroup.Item>
            <ListGroup.Item>
              <Button
